...
import 'package:nexcon/screen/organizer_section/abstract_and_paper/abstract_organizer/abstract_theam/abstract_organizer_edit.dart';
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                _buildToggleButton('Session/Themes', 0),
                const SizedBox(width: 8.0),
                _buildToggleButton('Review', 1),
              ],
            ),
          ),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              " ${item['abstraction']}",
                              style: FTextStyle.listTitleSub,maxLines: 4,
                                ...
                                GestureDetector(
                                  onTap: () {
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) =>
                                            AbstractOrganizerEdit(
                                              conferenceName:item['conferenceName'],
                                              abstractSession: item['abstraction'],

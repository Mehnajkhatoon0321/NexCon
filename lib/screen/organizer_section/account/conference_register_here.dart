...
class ConferenceRegisterHere extends StatefulWidget {
  const ConferenceRegisterHere({super.key});

  @override
  State<ConferenceRegisterHere> createState() => _ConferenceRegisterHereState();
}

class _ConferenceRegisterHereState extends State<ConferenceRegisterHere> {
  final animationsMap = {
  ...
  GlobalKey<FormFieldState<String>>();  late final GlobalKey<FormFieldState<String>> _uploadConferenceNameKey =
  GlobalKey<FormFieldState<String>>();
  late final FocusNode _uploadNameNode = FocusNode();
  late final FocusNode _uploadConferenceNameNode = FocusNode();
        ...
        ListView(
          ...
          children: [
            ...
            SizedBox(height: 10,),Text(
              "Fill up the form below to register and list your conference for Free.**",
              style: FTextStyle.headingMiddle.copyWith(
                  fontSize: 15,color: Colors.red
              ),
              textAlign: TextAlign.start,
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: FormFieldStyle
                          ...
                          .copyWith(
                        fillColor: Colors.white,
                        hintText: "Upload Conference Banner :",
                        suffixIcon: IconButton(
                          icon: const Icon(Icons.attach_file),
                          onPressed: () async {
                            final result = await FilePicker.platform

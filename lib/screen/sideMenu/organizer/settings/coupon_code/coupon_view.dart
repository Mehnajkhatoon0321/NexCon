...
class CouponView extends StatefulWidget {
  String id ;
   CouponView({super.key, required this.id});
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildDetailTile(
                              'Code:',
                              activeConferenceList['code']),
                          _buildDetailTile(
                              'Discount Types:',
                              activeConferenceList['discountTypes']),
                          _buildDetailTile(
                              'From Date:',
                              activeConferenceList['validFrom']),
                          _buildDetailTile(
                              'To Date:',
                              activeConferenceList['validTo']),

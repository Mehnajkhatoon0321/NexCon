...
class AccomondationFeeView extends StatefulWidget {
  String id;
   AccomondationFeeView({super.key,required  this.id});

  @override
  State<AccomondationFeeView> createState() => _AccomondationFeeViewState();
}

class _AccomondationFeeViewState extends State<AccomondationFeeView>  {

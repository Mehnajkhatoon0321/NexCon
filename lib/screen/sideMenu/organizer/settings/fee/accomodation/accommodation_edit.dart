...
class _AccommodationEditState extends State<AccommodationEdit> {
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              Text("Rate Per Day/ Per Person", style: FTextStyle.SubHeadingTxtStyle)
              ,
              ...
              TextFormField(
                ...
                decoration: FormFieldStyle.defaultAddressInputDecoration.copyWith(
                  hintText: "Rate Per Day / Per Person",

...
class AccommodationFreeView extends StatefulWidget {
  String id;
   AccommodationFreeView({required this.id,super.key});

  @override
  State<AccommodationFreeView> createState() => _AccommodationFreeViewState();
}

class _AccommodationFreeViewState extends State<AccommodationFreeView>  {
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        _buildDetailTile(
                            'Category:',
                            activeConferenceList['category']),
                        _buildDetailTile(
                            'Rate Per Day/ Per Person:',
                            activeConferenceList['retePerDay']),
                        _buildDetailTile(
                            'Currency:',
                            activeConferenceList['current']),

...
class ReceiptView extends StatefulWidget {
  String id;
   ReceiptView({required this.id,super.key});
...
class _ReceiptViewState extends State<ReceiptView> {
  ...
  'receipt_date_organizer': "12 dec 2025",
  'receipt_date_delegate': "12 dec 2025",
  }
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildDetailTile(
                              'Seal Stamp:',
                              activeConferenceList['seal_stamp']),
                          _buildDetailTile(
                              'Signature',
                              activeConferenceList['signature']),
                          _buildDetailTile(
                              'Receipt Date Organizer :',
                              activeConferenceList['receipt_date_organizer']),
                          _buildDetailTile(
                              'Receipt Date Delegates:',
                              activeConferenceList['receipt_date_delegate']),

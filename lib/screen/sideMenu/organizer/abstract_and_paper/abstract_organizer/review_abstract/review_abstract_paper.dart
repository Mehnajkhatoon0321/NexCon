...
class ReviewAbstractPaperRegistration extends StatefulWidget {
  String isEdit;
  String title;
   ReviewAbstractPaperRegistration({required this.title,required this.isEdit,super.key});

  @override
  State<ReviewAbstractPaperRegistration> createState() => _ReviewAbstractPaperRegistrationState();
}

class _ReviewAbstractPaperRegistrationState extends State<ReviewAbstractPaperRegistration> {
  final animationsMap = {

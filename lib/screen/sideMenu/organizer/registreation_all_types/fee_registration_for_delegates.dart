...
import '../../common_section/privacy_policy.dart';
import '../../common_section/term_condition.dart';
class FeeRegistrationForDelegates extends StatefulWidget {
  const FeeRegistrationForDelegates({super.key});

  @override
  State<FeeRegistrationForDelegates> createState() => _FeeRegistrationForDelegatesState();
}

class _FeeRegistrationForDelegatesState extends State<FeeRegistrationForDelegates> {
  final animationsMap = {

...
class DelegatesRegisterNameList extends StatefulWidget {
  const DelegatesRegisterNameList({super.key});

  @override
  State<DelegatesRegisterNameList> createState() => _DelegatesRegisterNameListState();
}

class _DelegatesRegisterNameListState extends State<DelegatesRegisterNameList> {
  int pageNo = 1;
  int totalPages = 0;
  int pageSize = 10;

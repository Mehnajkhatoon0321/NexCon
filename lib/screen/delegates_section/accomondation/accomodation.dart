    ...
    return
      ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final numberPerson = item['numberPerson']?.toString() ?? 'N/A';
          final numberDays = item['numberDays']?.toString() ?? 'N/A';
          ...
          final feeStatus = item['feeStatus'] ?? 'Pending';
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            'No. of persons: $numberPerson',
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
                            style: FTextStyle.style,
                          ),
                          Text(
                            'No. of Days: $numberDays',
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
                            style: FTextStyle.style,
                          ),
